...
class stateOptions extends React.Component {
    render() {
		return (
			<Input className="custom-select"  style={{background: "#2b2b31" , color:'rgb(160 163 165)' , border:'none',height:'50px',borderRadius:'0',width:'280px'}} type="select" name="coSelectState" id="coState">
